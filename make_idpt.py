...
# These page tables are written to reside at 0xFFFFB000
...
with open('idpt.bin', 'wb') as f:
    ...
    for i in range(512):
        ...
        if i == (0):
            ...
            pte = ((0xFFFFC000 >> PGSHIFT) << PTE_PPN_SHIFT) | node_permissions
        ...
        # if bit 38 is set to 1, then bits 63 down to 39 must be set to 1 as well
            ...
            pte = ((0xC000000 >> PGSHIFT) << PTE_PPN_SHIFT) | leaf_permissions
        elif i < 256:
